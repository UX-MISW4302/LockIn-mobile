...
fun FriendsScreen(navController: NavController) {
    ...
    Column(
        ...
        LazyColumn(modifier = Modifier.weight(1f)) {
            items(1) { // Cambia este número según la cantidad de amigos
                Card(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(8.dp),
                    ...
                    Row(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.profile_picture), // Asegúrate de tener la imagen en drawable
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text(text = "Santiago Sinisterra", fontSize = 18.sp)
                            Text(text = "Última conexión: 5h", fontSize = 14.sp, color = Color.Gray)
                        }
                        TextButton(onClick = { navController.navigate("friendprofile") }) {
